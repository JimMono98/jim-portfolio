...
const projects = [
    ...
    },
    {
        ...
        title: "Project 3",
        description: "Developed a responsive hotel website using HTML and CSS, focusing on clean design and usability. The site effectively showcases the hotel's offerings while ensuring compatibility across various devices and browsers.",
...
const Work = () => {
    ...
    return (
        ...
        >
            <div className="container mx-auto"> {/* Add relative positioning here */}
                <div className="flex flex-col xl:flex-row xl:gap-[30px]">
                    ...
                    <div className="w-full xl:w-[50%] relative"> {/* Add relative here for slider */}
                        <Swiper
                            spaceBetween={30}
                            slidesPerView={1}
